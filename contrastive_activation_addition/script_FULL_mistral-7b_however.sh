...
python generate_vectors.py --layers $(seq 0 31) --save_activations --use_mistral --behaviors "context-focus" --override_dataset "generate_dataset_llama_induce_output_mistral_however.json"
python normalize_vectors.py --use_mistral
python plot_activations.py --layers $(seq 0 31) --use_mistral --behaviors "context-focus" --override_dataset "generate_dataset_llama_induce_output_mistral_however.json"

# Get best layer with "test_ab_failures_llama_induce_output_mistral.json"
python prompting_with_steering.py --layers $(seq 0 31) --use_mistral --multipliers -1 0 1 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_failures_llama_induce_output_mistral_however.json"
python plot_results.py --layers $(seq 0 31) --multipliers -1 1 --type ab --behaviors "context-focus"

BESTLAYER=15 ## GET BEST LAYER HERE

python prompting_with_steering.py --layers $BESTLAYER --use_mistral --multipliers -3 -2 -1 0 1 2 3 4 5 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_failures_llama_induce_output_mistral_however.json"
