...
python generate_vectors.py --layers $(seq 0 31) --save_activations --use_latest --behaviors "context-focus" --override_dataset "generate_dataset_long_contexts_dummy.json" --multicontext
python normalize_vectors.py --use_latest
python plot_activations.py --layers $(seq 0 31) --use_latest --behaviors "context-focus" --override_dataset "generate_dataset_long_contexts_dummy.json"
...
python prompting_with_steering.py --layers $(seq 0 31) --use_latest --multipliers -1 0 1 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_multicontext_dummy.json" --multicontext
...
python prompting_with_steering.py --layers $BESTLAYER --use_latest --multipliers -3 -2 -1 0 1 2 3 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_multicontext_dummy.json" --multicontext
