...
class SteeringSettings:
    ...
    override_oe_dataset_path: Optional[str] = None
    ...
    def make_result_save_suffix(
        ...
        if self.override_oe_dataset_path is None:
            dpath = None
        else:
            dpath = self.override_oe_dataset_path.split("/")[-1].strip(".json")
    ...
    def filter_result_files_by_suffix(
        ...
        elements = {
            ...
            "model_size": self.model_size,
            "override_model_weights_path": self.override_model_weights_path,
            "dataset_path": self.override_oe_dataset_path,
        }
