...
## < ------------------------------------------------------------------ > 
## NO BASELINE OR CONTRASTIVE STEERING HERE, since it will take ages (and we have shown poorer quality outputs there)
## < ------------------------------------------------------------------ > 
## STEP 1 - TEST SHORT ANSWERS

# Train vectors using "generate_dataset_short_ans_cqformat.json"
python generate_vectors.py --layers $(seq 0 79) --save_activations --suffix "_short_ans" --use_mistral --behaviors "context-focus" --override_dataset "generate_dataset_short_ans_cqformat.json"
python normalize_vectors.py --use_mistral --suffix "_short_ans" --nlayers 80
python plot_activations.py --layers $(seq 0 79) --use_mistral --behaviors "context-focus" --suffix "_short_ans" --override_dataset "generate_dataset_short_ans_cqformat.json"

# Get best layer with "test_dataset_ab_short_ans_cqformat.json"
python prompting_with_steering.py --layers $(seq 0 79) --suffix "_short_ans" --use_mistral --multipliers -1 0 1 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_short_ans_cqformat.json"
python plot_results.py --layers $(seq 0 79) --suffix "_short_ans" --multipliers -1 1 --type ab --behaviors "context-focus"

BESTLAYER=34 ## GET BEST LAYER HERE
...
python prompting_with_steering.py --layers $BESTLAYER --suffix "_short_ans" --use_mistral --multipliers 0 1 2 3 4 --type open_ended --behaviors "context-focus" --override_oe_dataset_path "datasets/test/context-focus/test_dataset_varieties/test_dataset_open_ended_gpt_cleaning_750_cqformat.json"
...
python generate_vectors.py --layers $(seq 0 79) --save_activations --use_mistral --behaviors "context-focus" --override_dataset "generate_dataset_llama_induce_output.json"
python normalize_vectors.py --use_mistral --nlayers 80
python plot_activations.py --layers $(seq 0 79) --use_mistral --behaviors "context-focus" --override_dataset "generate_dataset_llama_induce_output.json"

# Get best layer with "test_ab_failures_llama_induce_output.json"
python prompting_with_steering.py --layers $(seq 0 79) --use_mistral --multipliers -1 0 1 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_failures_llama_induce_output.json"
python plot_results.py --layers $(seq 0 79) --multipliers -1 1 --type ab --behaviors "context-focus"

BESTLAYER=32 ## GET BEST LAYER HERE

python prompting_with_steering.py --layers $BESTLAYER --use_mistral --multipliers -3 -2 -1 0 1 2 3 4 5 6 7 --type ab --behaviors "context-focus" --override_ab_dataset "test_dataset_ab_failures_llama_induce_output.json"
python plot_results.py --layers $BESTLAYER --multipliers -3 -2 -1 0 1 2 3 4 5 6 7 --type ab --behaviors "context-focus"

# Test using "test_oe_failures_fixed_geval_87%.json"
python prompting_with_steering.py --layers $BESTLAYER --use_mistral --multipliers 0 1 2 4 5 --type open_ended --behaviors "context-focus" --override_oe_dataset_path "datasets/test/context-focus/test_dataset_varieties/test_dataset_open_ended_failures_fixed_geval_87%.json"
...
# Test using "test_dataset_open_ended_gpt_cleaning_750_cqformat.json"
python prompting_with_steering.py --layers $BESTLAYER --use_mistral --multipliers 1 2 3 4 5 --type open_ended --behaviors "context-focus" --override_oe_dataset_path "datasets/test/context-focus/test_dataset_varieties/test_dataset_open_ended_gpt_cleaning_750_cqformat.json"
