...
def load_data(type="regular",path="eval_data/failure_outputs.json",batch_size=5): # type = "regular_output" or "cad_output0.5" or ... (depends on which decoding method we want to evaluate)
    ...
    for i in range(len(data)):
        ...
        dic['answer'].append(point['outputs'][type])
